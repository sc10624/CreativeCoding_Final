// USING P5PLAY
//just started from scratch bc of many errors & wanted to re-organize code
...
function draw() {
	...
	print(player.colliding(endPoint));
...
if(kb.pressing(currentKeys[2]) && (player.colliding(r1ground) || player.colliding(r2ground) || player.colliding(r3ground))){
	player.vel.y = -3;
}
